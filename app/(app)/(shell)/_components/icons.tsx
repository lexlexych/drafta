...
/**
 * Автоответы: буква «A» и молния — «ответ, отправленный сам».
 *
 * Один значок на все три места: кнопка в шапке «Сообщений», пузырь автоответа в
 * треде и превью в списке диалогов. Раньше там стояли два разных рисунка, и
 * пометка на пузыре не читалась как то же самое, что переключатель наверху.
 *
 * Буква обводкой, молния заливкой: на 13–18 пикселях сплошная фигура рядом с
 * контурной различима, а две контурные сливаются в штриховку.
 *
...
export function AutoReplyIcon(props: IconProps) {
  return (
    <Icon fill="none" {...props}>
      <path
        d="M3.4 18.4L8.6 5.6l5.2 12.8M5.2 14.4h6.8"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M19.2 4.2L14.6 12.6h2.9L16.3 20l4.9-8.6h-3z"
        fill="currentColor"
      />
    </Icon>
  );
