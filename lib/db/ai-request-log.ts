 ...
 * call.
 *
 * Written from the Workflow pipelines and from the translation action, hence the
 ...
 * throws: it runs inside an Workflow step, where a failure should be retried and
