 ...
 *
 * Лиза заменяет `concurrency` Inngest с тем же лимитом 4 на воркспейс: вызов
 * лёгкий, но одновременных доставок одного тенанта всё же лучше ограничить,
 * не мешая при этом другим тенантам.
 */
