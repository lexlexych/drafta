...
/**
 * Прежний `NonRetriableError` Inngest — это `FatalError`: шаг падает сразу,
 * без повторов, и ошибка уходит в тело прогона, где её ловит компенсация.
 * Всё остальное пробрасывается как есть и ретраится по `maxRetries` шага.
 *
