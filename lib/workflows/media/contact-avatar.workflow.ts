 ...
 * (docs/architecture/05-channels.md). Лиза `contact-identity:<id>` с лимитом 1:
 * серия сообщений от одного человека не должна оборачиваться серией
 * одинаковых запросов за одной картинкой.
 *
