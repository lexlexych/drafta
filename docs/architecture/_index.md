...
| 18 | [Создание публикаций](18-publication-authoring.md) | Общий Custom GPT, OAuth, выбранные знания, импорт изображений и редактор черновиков |
...
[правило «только ID»](07-data-flows.md#62-генерация-черновика) ·
...
**Категории и база знаний** — [концепция](09-categories.md) ·
[таблица `kb_files`](06-data-model.md#kb_files) ·
[один вызов LLM в пайплайне](07-data-flows.md#пайплайн-генерации) ·
