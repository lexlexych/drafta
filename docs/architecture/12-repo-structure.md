...
│   └── workflow-operations/      # ошибки и ручной повтор
├── sw.ts                         # Serwist
lib/
├── channels/                     # types, registry, zernio/, postmark/, meta/(будущее)
├── workflows/                   # generate-draft, send-message, send-push, auto-reply, ...
...
| `lib/workflows/` | [7.6. Список функций](07-data-flows.md#66-полный-список-inngest-функций) |
