...
| [E-002](epic_02/_index.md) | Zernio-контур: адаптер, вебхук, Realtime-инбокс «Сообщения» | in_progress | 0/7 | 2026-07-19 | — |
...
| # | Тикет | Тип | Статус |
|---|---|---|---|
| T-01 | [Ядро слоя каналов: типы, интерфейс адаптера, реестр](epic_02/T-01-channels-core.md) | dev | in_progress |
